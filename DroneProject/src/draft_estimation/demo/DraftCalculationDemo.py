...
def main(img_path):
    ...
    if d_calc.pts:
        ...
        cv2.line(img, d_calc.wl_det.line[0], d_calc.wl_det.line[1], Color.YELLOW.value, 1, cv2.LINE_AA)
        cv2.putText(img, str(value), d_calc.wl_det.line[0], cv2.FONT_HERSHEY_SIMPLEX, 0.4, Color.YELLOW.value, 1, cv2.LINE_AA)
